...
const reviews: Review[] = [
  {
    ...
    rating: 5,
    topic: "Крутой сайт!!",
    text: "Мне очень понравился данный сайт тк в нем размещено большое количество достопримечательностей моего родного города Казани и в наших реалиях, считаю его очень нужным, потому что построек стало слишком много и найти из них что то интересное становится действительно трудно. Мне этот сайт очень помог- 5 звезд ⭐⭐⭐⭐⭐ ",
  },
  {
    id: 2,
    name: "Шамиль Газизов",
    ...
    rating: 5,
    topic: "Очень полезно",
    text: "Этот сайт невероятно помог мне спланировать маршрут! Я открыл для себя столько удивительных мест, о которых даже не подозревал. Все необходимое для поиска и выбора было под рукой.",
  },
  {
    id: 3,
    name: "HiroBatory",
  ...
  },
  {
    ...
    rating: 4,
    topic: "Рекомендую изучить",
    text: "Уже порекомендовал сайт нескольким знакомым. Мне понравилось оформление и простота в удобстве сайта. есть что доработать",
  },
  {
    id: 9,
    name: "Собакевич",
    ...
    rating: 5,
    topic: "Прикольно",
    text: "Сайт прикольный надеюсь в будущем будет еще больше достопримечательностей",
  },
];
