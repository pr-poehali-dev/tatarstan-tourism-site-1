...
const reviews: Review[] = [
  ...
  },
  {
    ...
    text: "Интерфейс простой и понятный. Быстро нашла нужную информацию о достопримечательностях. Очень довольна!",
  },
  {
    id: 5,
    name: "Игорь Волков",
    ...
    rating: 5,
    topic: "Отличный сервис",
    text: "С семьей посетили Казань по вашим рекомендациям. Все места оказались действительно интересными. Спасибо за проделанную работу!",
  },
  {
    id: 6,
    name: "Анна Кузнецова",
    ...
    text: "Карта работает отлично, информация актуальная. Несколько раз возвращалась к сайту во время путешествия.",
  },
  {
    id: 7,
    name: "Сергей Морозов",
    ...
    rating: 5,
    topic: "Помогло в поездке",
    text: "Впервые в Татарстане и не пожалел, что воспользовался этим сайтом. Узнал много нового и посетил самые красивые места.",
  },
  {
    id: 8,
    name: "Ольга Новикова",
